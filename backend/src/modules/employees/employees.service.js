...
export const create = async (employee) => {
    const { first_name, last_name, identification, phone, email, hire_date, street_address, city, state } = employee;
    const [result] = await mariaDB.query(
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [first_name, last_name, identification, phone, email, hire_date, street_address, city, state]
    );
...
export const update = async (id, employee) => {
    const { first_name, last_name, identification, phone, email, street_address, city, state } = employee;
    await mariaDB.query(
        `UPDATE EMPLOYEE 
        SET first_name = ?, last_name = ?, identification = ?, phone = ?, email = ?, street_address = ?, city = ?, state = ? 
        WHERE employee_id = ?`,
        [first_name, last_name, identification, phone, email, street_address, city, state, id]
    );
...
export const deleteEmployee = async (id) => {
    await mariaDB.query('UPDATE EMPLOYEE SET status = "Inactive" WHERE employee_id = ?', [id]);
};
